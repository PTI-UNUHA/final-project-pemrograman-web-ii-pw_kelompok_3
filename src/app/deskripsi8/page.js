      ...
      <section className="course-detail-hero">
        <div className="hero-left">
          <div className="hero-tags">
            <span className="tag orange">Security</span>
            <span className="tag purple">Menengah</span>
          </div>

          <h1>Cyber Security Fundamentals</h1>

          <p>Dasar-dasar keamanan siber dan cara melindungi sistem dari ancaman digital.</p>

        <p className="mentor">
            Oleh <span className="mentor-name">Ir. Bambang Sutopo</span>
        </p>
      ...
      <section className="course-content">
        ...
        <div className="content-left">
          ...
          <div className="box">
            ...
            <p>
              Dasar-dasar keamanan siber dan cara melindungi sistem dari ancaman digital.
            </p>
            <p>
