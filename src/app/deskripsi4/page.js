      ...
      <section className="course-detail-hero">
        <div className="hero-left">
          <div className="hero-tags">
            <span className="tag orange">Design</span>
            <span className="tag purple">Pemula</span>
          </div>

          <h1>UI/UX Design Mastery dengan Figma</h1>

          <p>Pelajari cara mendesain user interface dan user experience yang menarik menggunakan Figma.</p>

        <p className="mentor">
            Oleh <span className="mentor-name">Rina Wijaya</span>
        </p>
          ...
          <div className="hero-meta">
            ...
            <span>
                ...
                <strong>8.720</strong> Siswa
            </span>

            <span>
                <FiClock className="meta-icon" />
                <strong>15 jam</strong> Durasi
            </span>
        </div>
      ...
      <section className="course-content">
        ...
        <div className="content-left">
          ...
          <div className="box">
            ...
            <p>
              Pelajari cara mendesain user interface dan user experience yang menarik menggunakan Figma.
            </p>
            <p>
