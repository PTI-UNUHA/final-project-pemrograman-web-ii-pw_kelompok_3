      ...
      <section className="course-detail-hero">
        <div className="hero-left">
          <div className="hero-tags">
            <span className="tag orange">Marketing</span>
            <span className="tag purple">Pemula</span>
          </div>

          <h1>Digital Marketing untuk Pemula</h1>

          <p>Pelajari strategi digital marketing yang efektif untuk meningkatkan bisnis online Anda.</p>

        <p className="mentor">
            Oleh <span className="mentor-name">Hendra Gunawan</span>
        </p>
          ...
          <div className="hero-meta">
            ...
            <span>
                ...
                <strong>11.230</strong> Siswa
            </span>

            <span>
                <FiClock className="meta-icon" />
                <strong>10 jam</strong> Durasi
            </span>
        </div>
      ...
      <section className="course-content">
        ...
        <div className="content-left">
          ...
          <div className="box">
            ...
            <p>
              Pelajari strategi digital marketing yang efektif untuk meningkatkan bisnis online Anda.
            </p>
            <p>
