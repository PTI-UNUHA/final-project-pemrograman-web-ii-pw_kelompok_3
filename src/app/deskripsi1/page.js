  ...
  <button className="search-btn">🔍 Cari Kursus</button>
      ...
      <section className="course-detail-hero">
        <div className="hero-left">
          ...
          <h1>Dasar Pemrograman Web dengan HTML, CSS & JavaScript</h1>

          <p>
            Pelajari fundamental pemrograman web dari nol hingga bisa
            membuat website interaktif yang menarik.
          </p>

        <p className="mentor">
            Oleh <span className="mentor-name">Budi Santoso</span>
        </p>
          ...
          <div className="hero-meta">
            ...
            <span>
                ...
                <strong>15.420</strong> Siswa
            </span>

            <span>
                <FiClock className="meta-icon" />
                <strong>12 jam</strong> Durasi
            </span>
        </div>
      ...
      <section className="course-content">
        ...
        <div className="content-left">
          ...
          <div className="box">
            ...
            <p>
              Pelajari fundamental pemrograman web dari 
              nol hingga bisa membuat website interaktif yang menarik.
            </p>
            <p>
